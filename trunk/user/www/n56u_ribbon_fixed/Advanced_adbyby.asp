...
<html>
<head>
<title><#Web_Title#> - <#menu5_20_1#></title>
...
function textarea_scripts_enabled(v){
	...
	inputCtrl(document.form['scripts.adbyby_adplus.sh'], v);
}
...
function showMRULESList(){
	...
	if(m_rules.length == 0)
		...
		for(var i = 0; i < m_rules.length; i++){
		if(m_rules[i][1] == 0)
		adbybyrulesroad="<#btn_Disabled#>";
		else{
		adbybyrulesroad="<#btn_Enabled#>";
		}
		code +='<tr id="rowrl' + i + '">';
                        ...
                        <div class="box well grad_colour_dark_blue">
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <div>Adbyby Plus+ 规则条数：【<% nvram_get_x("", "adbyby_user"); %>】。</div>
                                    <div> </div>
                                    </div>
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        <tr> <th><#running_status#>:</th>
                                            <td id="adbyby_status" colspan="4"></td>
                                        </tr>
                                        <tr >
                                            <th width="50%">启用 Adbyby Plus+</th>
                                            <td>
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        <tr id="row_rules_caption" style="display:none">
                                            <th width="85%">
                                                <#BM_alert_IP1#> <i class="icon-circle-arrow-down"></i>
                                            </th>
                                            <th width="10%">
                                                <#t2Status#> <i class="icon-circle-arrow-down"></i>
                                            </th>
                                            <th width="5%">
                                            ...
                                            <td width="85%">
                                             ...
                                             <td width="10%">
                                              <select name="adbybyrules_road_x_0" class="input" style="width: 65px">
                                                    <option value="0" <% nvram_match_x("","adbybyrules_road_x_0", "0","selected"); %>><#btn_Disable#></option>
                                                    <option value="1" <% nvram_match_x("","adbybyrules_road_x_0", "1","selected"); %>><#btn_Enable#></option>
                                                </select>
                                            </td>
                                            <td width="5%">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        <tr id="row_static_caption" style="display:none">
                                            ...
                                            <th width="20%">
                                                <#menu5_6_1#> <a href="javascript:sortbyName();" style="outline:0;"><i class="icon-circle-arrow-down"></i></a>
                                            </th>
                                            <th width="5%">
                                        ...
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none;">
                                                ...
                                                <div id="script9" style="display:none;">
                                                    <textarea rows="5" wrap="off" spellcheck="false" maxlength="314571" class="span12" name="scripts.adbyby_adplus.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_adplus.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none;">
                                                ...
                                                <div id="script10" style="display:none;">
                                                    <textarea rows="5" wrap="off" spellcheck="false" maxlength="314571" class="span12" name="scripts.adbyby_adesc.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_adesc.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none;">
                                                ...
                                                <div id="script12" style="display:none;">
                                                    <textarea rows="5" wrap="off" spellcheck="false" maxlength="314571" class="span12" name="scripts.adbyby_adblack.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_adblack.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none;">
                                                ...
                                                <div id="script13" style="display:none;">
                                                    <textarea rows="5" wrap="off" spellcheck="false" maxlength="314571" class="span12" name="scripts.adbyby_rules.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_rules.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
